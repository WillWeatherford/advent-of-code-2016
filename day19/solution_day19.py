...
def steal_presents(num_elves, steal_across):
    """Return the elf remaining after many rounds of stealing.

    If steal_across is True, the elf halfway across the circle from the current
    elf is stolen from and eliminated.

    If steal_across is False, the elf clockwise in the circle from the current
    elf is stolen from and eliminated.
    """
